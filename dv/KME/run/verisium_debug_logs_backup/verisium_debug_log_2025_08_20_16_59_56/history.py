...
# history.py generated at 2025/08/20 09:35:11
# host: sjcvl-janec
# port: 45893
# launch command: indago -connect dc:sjcvl-janec.cadence.com:56479 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=45893,
        extra_args='-connect dc:sjcvl-janec.cadence.com:56479 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 45893
# Verisium: **************************************************************************************
