...
# history.py generated at 2025/08/20 14:24:52
# host: sjcvl-janec
# port: 38105
# launch command: indago -connect dc:sjcvl-janec.cadence.com:34429 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=38105,
        extra_args='-connect dc:sjcvl-janec.cadence.com:34429 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 38105
# Verisium: **************************************************************************************
