...
# history.py generated at 2025/08/21 10:14:54
# host: sjcvl-janec
# port: 38979
# launch command: indago -connect dc:sjcvl-janec.cadence.com:32991 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=38979,
        extra_args='-connect dc:sjcvl-janec.cadence.com:32991 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 38979
# Verisium: **************************************************************************************
