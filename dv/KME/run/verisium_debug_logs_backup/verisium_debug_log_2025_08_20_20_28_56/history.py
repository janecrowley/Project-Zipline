...
# history.py generated at 2025/08/20 13:28:56
# host: sjcvl-janec
# port: 33103
# launch command: indago -connect dc:sjcvl-janec.cadence.com:50167 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=33103,
        extra_args='-connect dc:sjcvl-janec.cadence.com:50167 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 33103
# Verisium: **************************************************************************************
