...
# history.py generated at 2025/08/20 09:24:25
# host: sjcvl-janec
# port: 38197
# launch command: indago -connect dc:sjcvl-janec.cadence.com:43053 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=38197,
        extra_args='-connect dc:sjcvl-janec.cadence.com:43053 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 38197
# Verisium: **************************************************************************************
