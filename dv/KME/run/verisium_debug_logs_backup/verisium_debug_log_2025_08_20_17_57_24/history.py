...
# history.py generated at 2025/08/20 10:57:24
# host: sjcvl-janec
# port: 38881
# launch command: indago -connect dc:sjcvl-janec.cadence.com:40737 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=38881,
        extra_args='-connect dc:sjcvl-janec.cadence.com:40737 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 38881
# Verisium: **************************************************************************************
