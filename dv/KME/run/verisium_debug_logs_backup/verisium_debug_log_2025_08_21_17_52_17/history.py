...
# history.py generated at 2025/08/21 10:52:17
# host: sjcvl-janec
# port: 46563
# launch command: indago -connect dc:sjcvl-janec.cadence.com:47177 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=46563,
        extra_args='-connect dc:sjcvl-janec.cadence.com:47177 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 46563
# Verisium: **************************************************************************************
