...
# history.py generated at 2025/08/21 11:33:53
# host: sjcvl-janec
# port: 43947
# launch command: indago -connect dc:sjcvl-janec.cadence.com:43445 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=43947,
        extra_args='-connect dc:sjcvl-janec.cadence.com:43445 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 43947
# Verisium: **************************************************************************************
