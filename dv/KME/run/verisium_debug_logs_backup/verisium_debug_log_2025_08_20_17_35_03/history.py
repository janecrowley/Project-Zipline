...
# history.py generated at 2025/08/20 10:35:03
# host: sjcvl-janec
# port: 34247
# launch command: indago -connect dc:sjcvl-janec.cadence.com:42705 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=34247,
        extra_args='-connect dc:sjcvl-janec.cadence.com:42705 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 34247
# Verisium: **************************************************************************************
