...
# history.py generated at 2025/08/21 10:27:04
# host: sjcvl-janec
# port: 37083
# launch command: indago -connect dc:sjcvl-janec.cadence.com:56687 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=37083,
        extra_args='-connect dc:sjcvl-janec.cadence.com:56687 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 37083
# Verisium: **************************************************************************************
