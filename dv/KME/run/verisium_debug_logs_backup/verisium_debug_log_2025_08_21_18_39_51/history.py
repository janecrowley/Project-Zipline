...
# history.py generated at 2025/08/21 11:39:51
# host: sjcvl-janec
# port: 44205
# launch command: indago -connect dc:sjcvl-janec.cadence.com:53137 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=44205,
        extra_args='-connect dc:sjcvl-janec.cadence.com:53137 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 44205
# Verisium: **************************************************************************************
