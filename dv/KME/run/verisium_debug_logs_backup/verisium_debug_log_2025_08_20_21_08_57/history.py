...
# history.py generated at 2025/08/20 14:08:57
# host: sjcvl-janec
# port: 42191
# launch command: indago -connect dc:sjcvl-janec.cadence.com:51179 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=42191,
        extra_args='-connect dc:sjcvl-janec.cadence.com:51179 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 42191
# Verisium: **************************************************************************************
