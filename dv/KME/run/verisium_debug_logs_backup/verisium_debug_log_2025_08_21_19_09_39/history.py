...
# history.py generated at 2025/08/21 12:09:39
# host: sjcvl-janec
# port: 35181
# launch command: indago -connect dc:sjcvl-janec.cadence.com:52749 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=35181,
        extra_args='-connect dc:sjcvl-janec.cadence.com:52749 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 35181
# Verisium: **************************************************************************************
