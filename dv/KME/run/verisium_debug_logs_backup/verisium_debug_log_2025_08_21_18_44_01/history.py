...
# history.py generated at 2025/08/21 11:44:01
# host: sjcvl-janec
# port: 44745
# launch command: indago -connect dc:sjcvl-janec.cadence.com:34611 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=44745,
        extra_args='-connect dc:sjcvl-janec.cadence.com:34611 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 44745
# Verisium: **************************************************************************************
